...
import { IoLogoHtml5, IoPaperPlaneOutline } from 'react-icons/io5'
// Images
    ...
    <Layout>
      <Container>
        ...
        <Section delay={0.1}>
          ...
          <ParagraphCard>
            I am a full stack software engineer based in Boston Massachusetts. I
            work closely with frontend teams to build unique user experiences
            from product designs. Personally, I bring a unique component based
            approach to frontend development which accelerates build time and
            frees teams to be their best selves while working hard to achieve
            great feats. Currently working with Acumen&apos;s {''}
            <Link
              href="https://payeth-stake-merchant.herokuapp.com/"
              color={'purple.600'}
              fontWeight="700"
            >
              Payeth
        ...
        <Section delay={0.2}>
          ...
          <BioSection>
            ...
            Software Engineering Intern at Acumen Digital
          </BioSection>
          <BioSection>
            <BioYear>2022</BioYear>
            SWE Prep Fellow at MLH Fellowship
          </BioSection>
          <BioSection>
            <BioYear>2021</BioYear>
            Lead Frontend Developer, Education Cooperative Society. (Non Profit)
          </BioSection>
          <BioSection>
            <BioYear>2021</BioYear>
            SWE Trainee at Google Developers Students Club, Nigeria
          </BioSection>
          <BioSection>
            <Link href="https://docs.google.com/document/d/1O6Pw30G0fZLhPqbr1k6YSO8H1nIqjfnpmDj81nHuI7c/edit#heading=h.1hxcpsc1hco2">
              <BioYear>
                <Button
